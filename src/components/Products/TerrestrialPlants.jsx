...
const TerrestrialPlants = () => {
  ...
  const terrariumImages = [
    "/Terrestrial plants/Alocasia/_DSC5806.JPG",
    "/Terrestrial plants/Anthurium/IMG_0413.JPG",
    "/Terrestrial plants/Bigonia/_DSC5808.JPG",
    "/Terrestrial plants/Coin plant/_DSC6010.JPG",
    "/Terrestrial plants/Bromelliad/_DSC5898.JPG",
    "/Terrestrial plants/Coleus/_DSC5849.JPG",
    "/Terrestrial plants/Dieffenbachia sterling/_DSC5915.JPG",
    "/Terrestrial plants/Dracaena reflexa/_DSC6006.JPG",
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-[#2E442F]/70 max-w-3xl mx-auto">
            Quality indoor and outdoor plants for your home and garden.</p>
        </div>
